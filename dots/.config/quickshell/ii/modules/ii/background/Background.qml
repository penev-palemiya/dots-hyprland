...
Variants {
    ...
    PanelWindow {
        ...
        // Our own copy, so deleting or moving the original no longer blanks the
        // desktop. Resolves video to its thumbnail exactly as before.
        property string wallpaperPath: WallpaperGeometry.renderPath
